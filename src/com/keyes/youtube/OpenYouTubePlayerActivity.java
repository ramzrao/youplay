			...
			try {
				...
				if( (lWifiManager.isWifiEnabled() && lWifiManager.getConnectionInfo() != null && lWifiManager.getConnectionInfo().getIpAddress() != 0) ||
					( (lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_UMTS ||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_1xRTT||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_CDMA||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_GPRS||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_HSDPA||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_HSPA||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_HSUPA||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_IDEN||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_UNKNOWN||
						lTelephonyManager.getNetworkType() == TelephonyManager.NETWORK_TYPE_EVDO_A||
